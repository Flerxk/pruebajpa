...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		cboCategorias.addItem("Seleccione_");// Opcion 0
		for (Categoria c : lstCategorias) {
			cboCategorias.addItem(c.getDescripcion());
		}
		List<Proveedores> Lstproveedores = em.createQuery("select c  from Proveedores c").getResultList();
		cboProveedores.addItem("Seleccione_");// Opcion 0
